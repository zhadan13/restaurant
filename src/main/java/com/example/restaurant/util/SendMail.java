...
public final class SendMail {
    ...
    public static void sendVerificationMail(final User user, final String token) {
        try {
            ...
            String text = "<h1>" + "Hello " + user.getName() + "! " + message.getSubject() + "</h1>" + "<p>" + "One more thing... " + "Please confirm your email address by going by following link: " + "</p>" + "<a href='https://diamond-restaurant.herokuapp.com/authorization?user=" + user.getId() + "&token=" + token + "''> Diamond Restaurant &#183; Confirm email address</a>";
    ...
    public static void sendInvitationMail(final User user) {
        try {
            ...
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(user.getEmail()));
            message.setSubject("Welcome to Diamond Restaurant!");
            String text = "<h1>" + "Hello " + user.getName() + "! " + message.getSubject() + "</h1>" + "<p>" + "Thank you for registering in our restaurant chain. " + "Please place your first order by going to the menu by link: " + "</p>" + "<a href='https://diamond-restaurant.herokuapp.com/home'> Diamond Restaurant &#183; Menu</a>";
            message.setContent(text, "text/html; charset=utf-8");
            message.saveChanges();
            Transport.send(message);
