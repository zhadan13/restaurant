...
/**
 * A class containing all used SQL queries.
 *
 * @author Zhadan Artem
 */
...
public final class SQLQuery {
    ...
    public static final String UPDATE_USER_AUTHORIZATION_STATUS_BY_ID = "UPDATE users SET authorized = ? WHERE id = ?";
    ...
    // SQL queries for TABLE password_salts
    ...
    // SQL queries for TABLE users_tokens
    public static final String INSERT_NEW_AUTHORIZATION_TOKEN = "INSERT INTO users_tokens VALUES (DEFAULT, ?, ?)";
    public static final String DELETE_AUTHORIZATION_TOKEN_BY_ID = "DELETE FROM users_tokens WHERE id = ?";
    public static final String GET_AUTHORIZATION_TOKEN_BY_ID = "SELECT * FROM users_tokens WHERE id = ?";
    public static final String GET_AUTHORIZATION_TOKEN_BY_USER_ID = "SELECT * FROM users_tokens WHERE user_id = ?";
    public static final String GET_ALL_AUTHORIZATION_TOKENS = "SELECT * FROM users_tokens";
    public static final String UPDATE_AUTHORIZATION_TOKEN = "UPDATE users_tokens SET token = ? WHERE user_id = ?";

    // SQL queries for TABLE products
    ...
    // SQL queries for TABLE orders_products
