    ...
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="<c:url value="/"/>" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">Restaurant &#183; Account</span>
            </a>
    ...
    <main>
        <div class="bg-light rounded-3 mx-auto text-center">
            <div class="container-fluid py-2 mb-2">
                <h6 class="display-6">Your account</h6>
            </div>
        </div>
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        <h6 class="f-w-600">
                                            <c:out value="${sessionScope.get('userName')}"/>
                                        </h6>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <h6 class="text-muted f-w-400">
                                                    <c:out value="${sessionScope.get('userPhone')}"/>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="bg-light rounded-3 mx-auto text-center">
            <div class="container-fluid py-2 mb-2">
                <h6 class="display-6">Your recent orders</h6>
            </div>
        </div>
        ...
        <c:choose>
            <c:when test="${sessionScope.allUserOrders == null || sessionScope.allUserOrders.size() == 0}">
                <div class="bg-light rounded-3 mx-auto text-center">
                    <div class="container-fluid py-2 mb-2">
                        <h6 class="display-6">You haven't ordered anything yet</h6>
                    </div>
                </div>
            </c:when>
            <c:otherwise>
                                    ...
                                    <div class="card user-card-full" style="margin: 10px 0 10px 0">
                                        <div class="row m-l-0 m-r-0">
                                            <div class="col-sm-4 user-profile"
                                                 style="background: -webkit-gradient(linear, left top, right top, from(rgba(235, 225, 235, 1)), to(rgba(254, 191, 1, 1)));
                                                background: linear-gradient(to right, rgba(254, 191, 1, 1), rgba(235, 225, 235, 1))">
                                                <div class="card-block text-center text-white">
                                                    <h6 class="f-w-600">Order number:
                                                        <c:out value="${currentOrder.id}"/>
                                                    </h6>
                                                </div>
                                                <div class="card-block text-center text-white">
                                                    <h6 class="m-b-10 f-w-600">Status</h6>
                                                    <h6 class="f-w-600 text-uppercase text-dark">
                                                        <c:out value="${currentOrder.status}"/>
                                                    </h6>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <h6 class="text-muted f-w-400">
                                                                <c:out value="${currentOrder.payment}"/>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
