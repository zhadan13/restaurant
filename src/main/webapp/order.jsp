        ...
        <div class="container py-3">
            <div class="bg-light rounded-3 mx-auto text-center">
                <div class="container-fluid py-2 mb-2">
                    <h6 class="display-6">${order_details}</h6>
                </div>
            </div>
                    ...
                    <div class="container">
                        <form action="order" method="post">
                            ...
                            <div class="input-details">
                                ...
                                <div class="col-sm-5">
                                    <label>${date_time}<input type="datetime-local" class="form-control" name="time"
                                                              required></label>
                                </div>
                                <div class="col-sm-10">
                                    <label>${payment}</label>
                                    <label>
                                        <select class="form-select" name="payment" required>
                                            <option value="">${payment_select_payment_type}</option>
                                            <option value="1">${cash}</option>
                                            <option value="2">${card_online}</option>
                                            <option value="3">${card_offline}</option>
                                        </select>
                                    </label>
                                </div>
