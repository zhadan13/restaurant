    ...
    <main>
        <div class="p-5 mb-4 bg-light rounded-3 mx-auto text-center">
            <div class="container-fluid py-5">
                <h1 class="display-5 fw-bold">Delivery information</h1>
            </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">Delivery within the city</h1>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">75 UAH</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">Delivery in the region</h1>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">50 UAH</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">Delivery for less than 200 UAH</h1>
                    </div>
                </div>
            </div>
        </div>
