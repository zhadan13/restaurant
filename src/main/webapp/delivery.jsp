...
<head>
    ...
    <title>Diamond Restaurant &#183; Delivery</title>
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        <h5 class="card-title pricing-card-title">Delivery within the city</h5>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title pricing-card-title">Delivery for less than 200 UAH</h5>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title pricing-card-title">Delivery in the region</h5>
                    </div>
                </div>
            </div>
        </div>
